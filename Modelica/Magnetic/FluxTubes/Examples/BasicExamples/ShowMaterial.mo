...
model ShowMaterial "Show material characteristic"
  ...
  parameter Modelica.Units.SI.Current I=1 "Peak exciting current";
  Modelica.Units.SI.MagneticFieldStrength H=coreNon_Hys.H
    "Magnetic field strength";
  Modelica.Units.SI.MagneticPolarization J=coreNon_Hys.B - mu_0*H
    "Magnetic polarization";
  Modelica.Units.SI.RelativePermeability mu_r=coreNon_Hys.mu_r
    "Relative permeability";
  Modelica.Units.SI.MagneticPolarization J_rD=combiTable1Ds.y[1]
    "Magnetic polarization from raw data";
  ...
  Modelica.Magnetic.FluxTubes.Basic.ElectroMagneticConverter measurementCoil(N=700) annotation (
      Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=180,
        origin={10,0})));
  ...
  Modelica.Magnetic.FluxTubes.Sensors.MagneticPotentialDifferenceSensor magVoltageSensor
    annotation (Placement(transformation(extent={{-30,40},{-10,20}})));
  Modelica.Blocks.Math.Gain gain(k=1/coreNon_Hys.l)
    annotation (Placement(transformation(extent={{-10,40},{10,60}})));
  parameter Modelica.Magnetic.FluxTubes.Material.SoftMagnetic.SSEE.M330_50A
