...
model EIcore "An iron core with shape E and I"
  ...
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid yokeUL(
    ...
    b(displayUnit="mm") = 0.02) "Upper Left yoke"
  ...
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid yokeUR(
    ...
    l(displayUnit="mm") = 0.075,
    a(displayUnit="mm") = 0.04,
    b(displayUnit="mm") = 0.02) "Upper RIght yoke"
  ...
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid yokeLL(
    ...
    l(displayUnit="mm") = 0.075,
    a(displayUnit="mm") = 0.04,
    b(displayUnit="mm") = 0.02) "Lower Left yoke"
  ...
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid yokeLR(
    ...
    l(displayUnit="mm") = 0.075,
    a(displayUnit="mm") = 0.04,
    b(displayUnit="mm") = 0.02) "Lower Right yoke"
    annotation (Placement(transformation(extent={{60,-90},{40,-70}})));
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid legL(
    ...
    a(displayUnit="mm") = 0.04,
    b(displayUnit="mm") = 0.02) "Left leg" annotation (Placement(transformation(
        extent={{10,10},{-10,-10}},
        rotation=90,
        origin={-80,0})));
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid legR(
    ...
    l(displayUnit="mm") = 0.1,
    a(displayUnit="mm") = 0.04,
    b(displayUnit="mm") = 0.02) "Right leg" annotation (Placement(
        transformation(
        extent={{10,10},{-10,-10}},
        rotation=90,
        origin={80,0})));
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid legM(
    ...
    a(displayUnit="mm") = 0.04,
    b(displayUnit="mm") = 0.04) "Middle leg" annotation (Placement(
  ...
  Modelica.Magnetic.FluxTubes.Shapes.FixedShape.Cuboid airgap(
    ...
    a(displayUnit="mm") = 0.04,
    b(displayUnit="mm") = 0.04) "Airgap" annotation (Placement(transformation(
        extent={{10,10},{-10,-10}},
        rotation=270)));
  Modelica.Magnetic.FluxTubes.Basic.Ground groundMag
    annotation (Placement(transformation(extent={{-10,-100},{10,-80}})));
  Modelica.Magnetic.FluxTubes.Basic.ElectroMagneticConverter excitingCoil(N=100)
  ...
  Modelica.Magnetic.FluxTubes.Sensors.MagneticFluxSensor magFluxSensor annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,-60})));
  ...
  Modelica.Magnetic.FluxTubes.Basic.ElectroMagneticConverter measurementCoil(N=100)
...
equation
  ...
  connect(yokeLL.port_n, groundMag.port)
    annotation (Line(points={{-40,-80},{0,-80}}, color={255,127,0}));
  connect(groundMag.port, yokeLR.port_n)
  ...
  connect(sineCurrent.n, excitingCoil.p)
  ...
  connect(groundE.p, excitingCoil.n)
  ...
  connect(magFluxSensor.port_p, groundMag.port)
    annotation (Line(points={{0,-70},{0,-80}}, color={255,127,0}));
  connect(yokeUL.port_p, legM.port_n)
    annotation (Line(points={{-40,80},{0,80},{0,70}}, color={255,127,0}));
  connect(legM.port_p, excitingCoil.port_p)
    annotation (Line(points={{0,50},{0,40}}, color={255,127,0}));
  connect(excitingCoil.port_n, airgap.port_n)
    annotation (Line(points={{0,20},{0,10}}, color={255,127,0}));
  connect(airgap.port_p, measurementCoil.port_p)
    annotation (Line(points={{0,-10},{0,-20}}, color={255,127,0}));
  connect(measurementCoil.port_n, magFluxSensor.port_n)
    annotation (Line(points={{0,-40},{0,-50}}, color={255,127,0}));
  connect(measurementCoil.p, voltageSensor.p)
    annotation (Line(points={{20,-20},{60,-20}}, color={0,0,255}));
  connect(measurementCoil.n, groundM.p)
    annotation (Line(points={{20,-40},{40,-40}}, color={0,0,255}));
  connect(groundM.p, voltageSensor.n)
    annotation (Line(points={{40,-40},{60,-40}}, color={0,0,255}));
